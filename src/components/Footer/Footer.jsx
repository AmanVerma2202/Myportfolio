    ...
    <footer className="footer-container" id="contact">
      ...
      <div className="footers-content">
        <h1 className="footers-heading">
          चलिए, साथ मिलकर कुछ <span className="highlight">कमाल</span> करते हैं!
        </h1>
        <p className="footers-text">
          Let’s connect today and turn your vision into reality &#8211; together, we’ll craft a path to your success!
        </p>
      ...
      <div className="footers-bottom">
        ...
        <div className="social-media-links">
            ...
            </svg><span><a target="blank" href="https://www.instagram.com/aka_amanverma/">Instagram</a></span>   
