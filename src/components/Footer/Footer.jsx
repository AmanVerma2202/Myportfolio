  ...
  return (
    <footer className="footer-container" id="contact">
      <div className="footers-content">
        <h1 className="footers-heading">
          Build something <span className="highlight">high-impact</span> with me.
        </h1>
        <p className="footers-text">
          Open to high-paying software roles, remote teams, NCR opportunities, and freelance work in full-stack development, AI automation, dashboards, and product builds.
        </p>
        <a href="mailto:aka.amanverma@gmail.com">
      ...
      <div className="footers-bottom">
        ...
        <div className="social-media-links">
            ...
            </svg><span><a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/aka_amanverma/">Instagram</a></span>   
